...
class TemplateHelper
{
    ...
    protected static $rootPath = 'template-parts/';
    ...
    protected function parseFilePath($path)
    {
        ...
        return get_template_directory() . '/' . trim($path, '\\/');
    }
...
function green_template($path, $data = [], $echo = true) {
    return new TemplateHelper($path, $data, $echo);
}

function green_var($key, $default = null) {
